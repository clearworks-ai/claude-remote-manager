...
```bash
cat > ~/code/knowledge-sync/cc/sessions/clearpath-dev-handoff-$(date +%Y-%m-%d-%H%M).md << 'HANDOFF'
---
type: handoff
agent: clearpath-dev
created: <timestamp>
...
**On Session Start**, read latest handoff: `ls -t ~/code/knowledge-sync/cc/sessions/clearpath-dev-handoff-*.md 2>/dev/null | head -1`
